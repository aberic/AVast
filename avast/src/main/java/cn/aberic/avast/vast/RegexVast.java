...
public class RegexVast {
     ...
     * 是否为规范的手机电话号码
     * <p/>
     * 支持130——139、150——159、180——189、170——179、147号段
     *
     * @param toCheckStr
     *         toCheckStr
     *
    ...
    public boolean isMobile(String toCheckStr) {
        return canMatch(toCheckStr,  "^1{1}(3{1}\\d{1}|5{1}[0123456789]{1}|8{1}\\d{1})|7{1}\\d{1}|(147)\\d{8}$");
    }
    ...
    /**
     * 验证是否只能输入由数字、26个英文字母或者下划线组成的字符串.
     *
     * @param toCheckStr
     *         待验证的字符串
     *
     * @return 是否通过验证
     */
    public boolean isNumAndChar(String toCheckStr) {
        return canMatch(toCheckStr, "^\\w+$");
    }
