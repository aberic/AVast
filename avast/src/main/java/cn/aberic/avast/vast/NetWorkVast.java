...
public class NetWorkVast {
    ...
    public NetWorkVast(Context context) {
        ...
        if (networkInfo.isConnected()) {
            ...
            if ("WIFI".equalsIgnoreCase(typeName)) {
                ...
                switch (networkInfo.getSubtype()) {
                    ...
                    case 17://NETWORK_TYPE_TD_SCDMA(3G)
    ...
    public boolean isBluetoothByType() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            return getCurrentNetworkType() == ConnectivityManager.TYPE_BLUETOOTH;
        }
    }
    ...
    public boolean isDummyByType() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
            return false;
        } else {
            return getCurrentNetworkType() == ConnectivityManager.TYPE_DUMMY;
        }
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB_MR2)
    public boolean isEthernetByType() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
            return false;
        } else {
            return getCurrentNetworkType() == ConnectivityManager.TYPE_ETHERNET;
        }
    }
    ...
    public boolean isMobileDunByType() {
        return getCurrentNetworkType() == ConnectivityManager.TYPE_MOBILE_DUN;
    }
    ...
    public boolean isMobileHipriByType() {
        return getCurrentNetworkType() == ConnectivityManager.TYPE_MOBILE_HIPRI;
    }
    ...
    public boolean isMobileMmsByType() {
        return getCurrentNetworkType() == ConnectivityManager.TYPE_MOBILE_MMS;
    }
    ...
    public boolean isMobileSuplByType() {
        return getCurrentNetworkType() == ConnectivityManager.TYPE_MOBILE_SUPL;
    }
     ...
     */
    public boolean is1XRTTBySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_1xRTT;
    }
    ...
    public boolean isCDMABySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_CDMA;
    }
    ...
    public boolean isEDGEBySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_EDGE;
    }
    ...
    public boolean isEHRPDBySubtype() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_EHRPD;
        }
    }
    ...
    public boolean isEVDO_0BySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_EVDO_0;
    }
    ...
    public boolean isEVDO_ABySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_EVDO_A;
    }
    ...
    public boolean isEVDO_BBySubtype() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.GINGERBREAD) {
            ...
            return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_EVDO_B;
        }
    }
    ...
    public boolean isGPRSBySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_GPRS;
    }
    ...
    public boolean isHSDPABySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_HSDPA;
    }
    ...
    public boolean isHSPABySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_HSPA;
    }
    ...
    public boolean isHSPAPBySubtype() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
            ...
            return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_HSPAP;
        }
    }
    ...
    public boolean isHSUPABySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_HSUPA;
    }
    ...
    public boolean isIDENBySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_IDEN;
    }
    ...
    public boolean isLTEBySubtype() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_LTE;
        }
    }
    ...
    public boolean isUMTSBySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_UMTS;
    }
    ...
    public boolean isUNKNOWNBySubtype() {
        return getCurrentNetworkSubtype() == TelephonyManager.NETWORK_TYPE_UNKNOWN;
    }
    ...
    public boolean setWifi(boolean enable)
        ...
        if (isWifiOpen() != enable) {
            ((WifiManager) mContext.getSystemService(Context.WIFI_SERVICE)).setWifiEnabled(enable);
        }
        return true;
    }
    ...
    public boolean isMobileNetworkOpen() {
        return (((ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE)).getNetworkInfo(ConnectivityManager.TYPE_MOBILE)).isConnected();
    }
