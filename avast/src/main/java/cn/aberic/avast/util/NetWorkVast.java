...
public class NetWorkVast {
     ...
     */
    public NetworkInfo.State getCurrentNetworkState(Context context) {
     ...
     */
    public int getCurrentNetworkSubtype(Context context) {
        NetworkInfo networkInfo = ((ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
     ...
     */
    public boolean isConnectedByState(Context context) {
     ...
     * @return 当前网络是否正在连接
     */
    public boolean isConnectingByState(Context context) {
     ...
     * @return 当前网络是否已经断开
     */
    public boolean isDisconnectedByState(Context context) {
     ...
     * @return 当前网络是否正在断开
     */
    public boolean isDisconnectingByState(Context context) {
     ...
     * @return 当前网络是否已经暂停
     */
    public boolean isSuspendedByState(Context context) {
     ...
     */
    public boolean isUnknownByState(Context context) {
    ...
    public boolean isBluetoothByType(Context context) {
     ...
     */
    public boolean isMobileByType(Context context) {
     ...
     */
    public boolean isMobileDunByType(Context context) {
     ...
     */
    public boolean isMobileHipriByType(Context context) {
     ...
     */
    public boolean isMobileMmsByType(Context context) {
     ...
     */
    public boolean isMobileSuplByType(Context context) {
     ...
     */
    public boolean isWifiByType(Context context) {
     ...
     */
    public boolean isWimaxByType(Context context) {
     ...
     */
    public boolean isCDMABySubtype(Context context) {
     ...
     */
    public boolean isEDGEBySubtype(Context context) {
    ...
    public boolean isEHRPDBySubtype(Context context) {
     ...
     */
    public boolean isEVDO_0BySubtype(Context context) {
     ...
     */
    public boolean isEVDO_ABySubtype(Context context) {
    ...
    public boolean isEVDO_BBySubtype(Context context) {
     ...
     */
    public boolean isGPRSBySubtype(Context context) {
     ...
     */
    public boolean isHSDPABySubtype(Context context) {
     ...
     */
    public boolean isHSPABySubtype(Context context) {
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB_MR2)
    public boolean isHSPAPBySubtype(Context context) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR2) {
            return false;
        } else {
     ...
     */
    public boolean isHSUPABySubtype(Context context) {
     ...
     */
    public boolean isIDENBySubtype(Context context) {
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public boolean isLTEBySubtype(Context context) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            return false;
        } else {
     ...
     */
    public boolean isUMTSBySubtype(Context context) {
     ...
     */
    public boolean isUNKNOWNBySubtype(Context context) {
     ...
     */
    public boolean isChinaMobile2G(Context context) {
     ...
     */
    public boolean isChinaUnicom2G(Context context) {
     ...
     */
    public boolean isChinaUnicom3G(Context context) {
     ...
     */
    public boolean isChinaTelecom2G(Context context) {
     ...
     */
    public boolean isChinaTelecom3G(Context context) {
     ...
     *         没有找到wifi设备
     */
    public int getWifiState(Context context) throws Exception {
     ...
     */
    public boolean isWifiOpen(Context context) throws Exception {
     ...
     * @return 设置是否成功
     */
    public boolean setWifi(Context context, boolean enable)
            throws Exception {
